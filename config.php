...
$config = array(
	...
	'experiencetable_rows' => 250, // till how many levels in one column
...
$config['client_download'] = 'https://drive.google.com/file/d/1nRI3XPDu_3Jqw0EiuGOK9yAbCfXm3e0A/view?usp=sharing';
$config['client_download_linux'] = ''. $config['client'] .'/tar/linux';
