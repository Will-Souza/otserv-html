...
/* team.html.twig */
class __TwigTemplate_2e20182ccaf87d44d50e0590f11051afbdcb29b240f549a86c28211daa6fd431 extends Twig_Template
{
...
\t\t\t\t\t";
        ...
        // line 21
        echo "\t\t\t\t\t";
        if (($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "team_style", array()) == 1)) {
            // line 22
            echo "
...
\t\t\t\t\t\t\t\t";
            // line 29
            if ($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "team_display_outfit", array())) {
                // line 30
...
\t\t\t\t\t\t\t\t";
            // line 39
            if ($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "team_display_status", array())) {
                // line 40
                echo "\t\t\t\t\t\t\t\t<td class=\"white\">
\t\t\t\t\t\t\t\t\t<b>Status</b>
\t\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t";
            // line 45
            if (($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "multiworld", array()) || $this->getAttribute((isset($context["config"]) ? $context["config"] : null), "team_display_world", array()))) {
                // line 46
                echo "\t\t\t\t\t\t\t\t<td class=\"white\">
\t\t\t\t\t\t\t\t\t<b>World</b>
\t\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t\t";
            // line 51
            if ($this->getAttribute((isset($context["config"]) ? $context["config"] : null), "team_display_lastlogin", array())) {
                // line 52
                echo "\t\t\t\t\t\t\t\t<td class=\"white\">
\t\t\t\t\t\t\t\t\t<b>Last login</b>
\t\t\t\t\t\t\t\t</td>
...
\t\t\t\t\t\t\t";
            ...
            $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, (isset($context["groupmember"]) ? $context["groupmember"] : null)));
...
(isset($context["config"]) ? $context["config"] : null), "team_style", array()) == 2)) {
            // line 105
            echo "\t\t\t\t\t\t";
            $context['_parent'] = $context;
            $context['_seq'] = twig_ensure_traversable(twig_reverse_filter($this->env, (isset($context["groupmember"]) ? $context["groupmember"] : null)));
...
";
    ...
    {
        return new Twig_Source("", "team.html.twig", "/var/www/html/system/templates/team.html.twig");
    }
}
